...
test.describe("Road Races Index", () => {
  ...
  test("has a header", async ({ page }) => {
    ...
    await expect(page.getByRole("heading", { name: "Our Favorite Road Races" })).toBeVisible();
  })
  ...
  test("lists all road races", async ({ page }) => {
    ...
    await expect(page
      .getByRole("listitem"))
      .toHaveText(["Disney Princess Half Marathon - 13.1 Miles", "Moab Trail Marathon - 26.2 Miles"]);
